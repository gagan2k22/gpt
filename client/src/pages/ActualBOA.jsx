        ...
        <Box sx={{ ...pageContainerStyles, ...pageTransitionStyles }}>
            ...
            <Paper elevation={2} sx={{ mb: 2 }}>
                <Tabs value={activeTab} onChange={(e, newValue) => setActiveTab(newValue)} sx={{ borderBottom: 1, borderColor: 'divider' }}>
                    <Tab label="Actual BOA Values" />
                    <Tab label="Actual BOA Percentage Allocation" />
                </Tabs>
            </Paper>
            ...
            {activeTab === 0 && (
                <Paper sx={{ width: '100%', mb: 2, boxShadow: 3 }}>
                    <TableContainer sx={{ maxHeight: 'calc(100vh - 280px)', border: '1px solid #217346' }}>
                        <Table
                            stickyHeader
                            size="small"
                            sx={{
            ...
            {activeTab === 1 && (
                <Paper sx={{ width: '100%', mb: 2, boxShadow: 3 }}>
                    <TableContainer sx={{ maxHeight: 'calc(100vh - 280px)', border: '1px solid #2e7d32' }}>
                        <Table
                            stickyHeader
                            size="small"
                            sx={{
                                    ...
                                    {columns.map((column) => (
                                        <TableCell
                                            ...
                                            style={{
                                                ...
                                                borderRight: column.sticky ? '2px solid #2e7d32' : '1px solid #d0d0d0'
                                            }}
                                        >
                                            {column.label}
                                        </TableCell>
